...
// Estados alterados: cada quien los pone y los quita sobre lo suyo
router.patch('/:id/estados',                   authenticate, ctrl.setEstados)
router.patch('/:id/pokemon/:idpp/estados',     authenticate, ctrl.setEstadosPokemon)
router.get('/:id/equipo',          authenticate, ctrl.getEquipo)
router.post('/:id/equipo',         authenticate, ctrl.addEquipo)
router.post('/:id/equipo/:idEquipo/usar', authenticate, ctrl.usarItemCurativo)
...
router.patch('/:id/inspirado',     authenticate, ctrl.setInspirado)
...
router.post('/:id/pokemon/:idpp/held-items',         authenticate, heldItemCtrl.addHeldItem)
router.delete('/:id/pokemon/:idpp/held-items/:idhi', authenticate, heldItemCtrl.removeHeldItem)
router.post('/:id/pokemon/:idpp/held-items/:idhi/usar', authenticate, heldItemCtrl.useHeldItem)
