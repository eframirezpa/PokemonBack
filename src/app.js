...
const masterPokemonRoutes    = require('./routes/master_pokemon.routes')
const masterNpcRoutes        = require('./routes/master_npc.routes')
const pokemonLevelsRoutes    = require('./routes/pokemon_levels.routes')
const pokemonExpLevelsRoutes = require('./routes/pokemon_experience_levels.routes')
...
app.use('/api/master/pokemon',    masterPokemonRoutes)
app.use('/api/master/npc',        masterNpcRoutes)
app.use('/api/pokemon-levels',    pokemonLevelsRoutes)
app.use('/api/pokemon-experience-levels', pokemonExpLevelsRoutes)
